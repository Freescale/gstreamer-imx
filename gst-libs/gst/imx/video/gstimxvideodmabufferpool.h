 ...
 *
 * Using this pool is not strictly necessary if elements exclusively
 * use single-memory gstbuffers; a regular buffer pool combined with
 * a DMA buffer allocator also works. But for multi-memory gstbuffers,
 * using GstImxVideoDmaBufferPool is recommended.
 *
