...
{
#define PIXEL_FORMAT_DESC(DESC, FMT, NUM_PLANES, FIRST_PLANE_BPP, X_SS, Y_SS, IS_SEMI_PLANAR, IS_TILED) \
	case (IMX_2D_PIXEL_FORMAT_##FMT): \
	{ \
		static Imx2dPixelFormatInfo const info = { \
			(DESC), (NUM_PLANES), (FIRST_PLANE_BPP), (X_SS), (Y_SS), (IS_SEMI_PLANAR), (IS_TILED) \
		}; \
		return &info; \
	}
	...
	switch (format)
	{
		PIXEL_FORMAT_DESC("RGB 5:6:5", RGB565, 1, 16, 1, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("BGR 5:6:5", BGR565, 1, 16, 1, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("RGB 8:8:8", RGB888, 1, 24, 1, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("BGR 8:8:8", BGR888, 1, 24, 1, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("RGBX 8:8:8:8", RGBX8888, 1, 32, 1, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("RGBA 8:8:8:8", RGBA8888, 1, 32, 1, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("BGRX 8:8:8:8", BGRX8888, 1, 32, 1, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("BGRA 8:8:8:8", BGRA8888, 1, 32, 1, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("XRGB 8:8:8:8", XRGB8888, 1, 32, 1, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("ARGB 8:8:8:8", ARGB8888, 1, 32, 1, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("XBGR 8:8:8:8", XBGR8888, 1, 32, 1, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("ABGR 8:8:8:8", ABGR8888, 1, 32, 1, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("grayscale 8", GRAY8, 1, 8, 1, 1, FALSE, FALSE)

		PIXEL_FORMAT_DESC("YUV 4:2:2 packed UYVY", PACKED_YUV422_UYVY, 1, 16, 2, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("YUV 4:2:2 packed YUYV", PACKED_YUV422_YUYV, 1, 16, 2, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("YUV 4:2:2 packed YVYU", PACKED_YUV422_YVYU, 1, 16, 2, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("YUV 4:2:2 packed VYUY", PACKED_YUV422_VYUY, 1, 16, 2, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("YUV 4:4:4 packed", PACKED_YUV444, 1, 24, 1, 1, FALSE, FALSE)

		PIXEL_FORMAT_DESC("YUV 4:2:0 semi planar NV12", SEMI_PLANAR_NV12, 2, 8, 2, 2, TRUE, FALSE)
		PIXEL_FORMAT_DESC("YUV 4:2:0 semi planar NV21", SEMI_PLANAR_NV21, 2, 8, 2, 2, TRUE, FALSE)
		PIXEL_FORMAT_DESC("YUV 4:2:2 semi planar NV16", SEMI_PLANAR_NV16, 2, 8, 2, 1, TRUE, FALSE)
		PIXEL_FORMAT_DESC("YUV 4:2:2 semi planar NV61", SEMI_PLANAR_NV61, 2, 8, 2, 1, TRUE, FALSE)

		PIXEL_FORMAT_DESC("YUV 4:2:0 fully planar YV12", FULLY_PLANAR_YV12, 3, 8, 2, 2, FALSE, FALSE)
		PIXEL_FORMAT_DESC("YUV 4:2:0 fully planar I420", FULLY_PLANAR_I420, 3, 8, 2, 2, FALSE, FALSE)
		PIXEL_FORMAT_DESC("YUV 4:2:2 fully planar Y42B", FULLY_PLANAR_Y42B, 3, 8, 2, 1, FALSE, FALSE)
		PIXEL_FORMAT_DESC("YUV 4:4:4 fully planar Y444", FULLY_PLANAR_Y444, 3, 8, 1, 1, FALSE, FALSE)

		PIXEL_FORMAT_DESC("YUV 4:2:0 semi planar NV12 tiled Amphion 8x128", TILED_NV12_AMPHION_8x128, 2, 8, 2, 2, TRUE, TRUE)
		PIXEL_FORMAT_DESC("YUV 4:2:0 semi planar NV21 tiled Amphion 8x128", TILED_NV21_AMPHION_8x128, 2, 8, 2, 2, TRUE, TRUE)

		PIXEL_FORMAT_DESC("YUV 4:2:0 semi planar NV12 tiled Amphion 8x128 10-bit", TILED_NV12_AMPHION_8x128_10BIT, 2, 10, 2, 2, TRUE, TRUE)
		PIXEL_FORMAT_DESC("YUV 4:2:0 semi planar NV21 tiled Amphion 8x128 10-bit", TILED_NV21_AMPHION_8x128_10BIT, 2, 10, 2, 2, TRUE, TRUE)
