 ...
 * @see_also: #GstImxG2DTextRender, #GstImxG2DTextOverlay, #GstImxG2DTimeOverlay
 *
...
G_DEFINE_TYPE (GstImxG2DTextOverlay, gst_imx_g2d_text_overlay, GST_TYPE_IMX_G2D_BASE_TEXT_OVERLAY);

static void
gst_imx_g2d_text_overlay_class_init (GstImxG2DTextOverlayClass * klass)
{
...
static void
gst_imx_g2d_text_overlay_init (GstImxG2DTextOverlay * overlay)
{
}
