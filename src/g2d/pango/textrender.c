...
#define DEFAULT_PROP_VALIGNMENT GST_IMX_G2D_TEXT_RENDER_VALIGN_BASELINE
#define DEFAULT_PROP_HALIGNMENT GST_IMX_G2D_TEXT_RENDER_HALIGN_CENTER
#define DEFAULT_PROP_LINE_ALIGNMENT GST_IMX_G2D_TEXT_RENDER_LINE_ALIGN_CENTER
...
#define GST_TYPE_IMX_G2D_TEXT_RENDER_VALIGN (gst_imx_g2d_text_render_valign_get_type())
static GType
gst_imx_g2d_text_render_valign_get_type (void)
{
  static GType text_render_valign_type = 0;
  static const GEnumValue text_render_valign[] = {
    {GST_IMX_G2D_TEXT_RENDER_VALIGN_BASELINE, "baseline", "baseline"},
    {GST_IMX_G2D_TEXT_RENDER_VALIGN_BOTTOM, "bottom", "bottom"},
    {GST_IMX_G2D_TEXT_RENDER_VALIGN_TOP, "top", "top"},
    {0, NULL, NULL},
  };

  if (!text_render_valign_type) {
    text_render_valign_type =
        g_enum_register_static ("GstImxG2DTextRenderVAlign", text_render_valign);
  }
  return text_render_valign_type;
}

#define GST_TYPE_IMX_G2D_TEXT_RENDER_HALIGN (gst_imx_g2d_text_render_halign_get_type())
static GType
gst_imx_g2d_text_render_halign_get_type (void)
{
  static GType text_render_halign_type = 0;
  static const GEnumValue text_render_halign[] = {
    {GST_IMX_G2D_TEXT_RENDER_HALIGN_LEFT, "left", "left"},
    {GST_IMX_G2D_TEXT_RENDER_HALIGN_CENTER, "center", "center"},
    {GST_IMX_G2D_TEXT_RENDER_HALIGN_RIGHT, "right", "right"},
    {0, NULL, NULL},
  };

  if (!text_render_halign_type) {
    text_render_halign_type =
        g_enum_register_static ("GstImxG2DTextRenderHAlign", text_render_halign);
  }
  return text_render_halign_type;
}

#define GST_TYPE_IMX_G2D_TEXT_RENDER_LINE_ALIGN (gst_imx_g2d_text_render_line_align_get_type())
static GType
gst_imx_g2d_text_render_line_align_get_type (void)
{
  static GType text_render_line_align_type = 0;
  static const GEnumValue text_render_line_align[] = {
    {GST_IMX_G2D_TEXT_RENDER_LINE_ALIGN_LEFT, "left", "left"},
    {GST_IMX_G2D_TEXT_RENDER_LINE_ALIGN_CENTER, "center", "center"},
    {GST_IMX_G2D_TEXT_RENDER_LINE_ALIGN_RIGHT, "right", "right"},
    {0, NULL, NULL}
  };

  if (!text_render_line_align_type) {
    text_render_line_align_type =
        g_enum_register_static ("GstImxG2DTextRenderLineAlign",
        text_render_line_align);
  }
  return text_render_line_align_type;
}

static void gst_imx_g2d_text_render_adjust_values_with_fontdesc (GstImxG2DTextRender *
    render, PangoFontDescription * desc);

#define gst_imx_g2d_text_render_parent_class parent_class
G_DEFINE_TYPE (GstImxG2DTextRender, gst_imx_g2d_text_render, GST_TYPE_ELEMENT);

static void gst_imx_g2d_text_render_finalize (GObject * object);
static void gst_imx_g2d_text_render_set_property (GObject * object,
    guint prop_id, const GValue * value, GParamSpec * pspec);
static void gst_imx_g2d_text_render_get_property (GObject * object,
    guint prop_id, GValue * value, GParamSpec * pspec);

static void
gst_imx_g2d_text_render_class_init (GstImxG2DTextRenderClass * klass)
{
  ...
  gobject_class->finalize = gst_imx_g2d_text_render_finalize;
  gobject_class->set_property = gst_imx_g2d_text_render_set_property;
  gobject_class->get_property = gst_imx_g2d_text_render_get_property;
  ...
  g_object_class_install_property (G_OBJECT_CLASS (klass), PROP_VALIGNMENT,
      g_param_spec_enum ("valignment", "vertical alignment",
          "Vertical alignment of the text", GST_TYPE_IMX_G2D_TEXT_RENDER_VALIGN,
          DEFAULT_PROP_VALIGNMENT, G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS));
  g_object_class_install_property (G_OBJECT_CLASS (klass), PROP_HALIGNMENT,
      g_param_spec_enum ("halignment", "horizontal alignment",
          "Horizontal alignment of the text", GST_TYPE_IMX_G2D_TEXT_RENDER_HALIGN,
  ...
  g_object_class_install_property (G_OBJECT_CLASS (klass), PROP_LINE_ALIGNMENT,
      g_param_spec_enum ("line-alignment", "line alignment",
          ...
          GST_TYPE_IMX_G2D_TEXT_RENDER_LINE_ALIGN, DEFAULT_PROP_LINE_ALIGNMENT,
          G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS));
}

static void
gst_imx_g2d_text_render_adjust_values_with_fontdesc (GstImxG2DTextRender * render,
...
static void
gst_imx_g2d_text_render_render_pangocairo (GstImxG2DTextRender * render)
{
  cairo_t *cr;
...
static void
gst_imx_g2d_text_render_check_argb (GstImxG2DTextRender * render)
{
  GstCaps *peer_caps;
...
static gboolean
gst_imx_g2d_text_render_src_setcaps (GstImxG2DTextRender * render, GstCaps * caps)
{
  ...
  gst_imx_g2d_text_render_check_argb (render);
...
static GstCaps *
gst_imx_g2d_text_render_fixate_caps (GstImxG2DTextRender * render, GstCaps * caps)
{
  GstStructure *s;
...
static void
gst_imx_g2d_text_renderer_image_to_ayuv (GstImxG2DTextRender * render, guchar * pixbuf,
...
static void
gst_imx_g2d_text_renderer_image_to_argb (GstImxG2DTextRender * render, guchar * pixbuf,
    int xpos, int ypos, int stride)
{
  int i, j;
  guchar *p, *bitp;
...
gst_imx_g2d_text_render_chain (GstPad * pad, GstObject * parent, GstBuffer * inbuf)
{
  GstImxG2DTextRender *render;
  GstFlowReturn ret;
  GstBuffer *outbuf;
  ...
  render = GST_IMX_G2D_TEXT_RENDER (parent);
  ...
  gst_imx_g2d_text_render_render_pangocairo (render);
  ...
  caps = gst_imx_g2d_text_render_fixate_caps (render, caps);

  if (!gst_imx_g2d_text_render_src_setcaps (render, caps)) {
    GST_ELEMENT_ERROR (render, CORE, NEGOTIATION, (NULL), (NULL));
    ret = GST_FLOW_ERROR;
    goto done;
  }
  ...
  switch (render->halign) {
    case GST_IMX_G2D_TEXT_RENDER_HALIGN_LEFT:
      xpos = render->xpad;
      break;
    case GST_IMX_G2D_TEXT_RENDER_HALIGN_CENTER:
      xpos = (render->width - render->image_width) / 2;
      break;
    case GST_IMX_G2D_TEXT_RENDER_HALIGN_RIGHT:
  ...
  switch (render->valign) {
    case GST_IMX_G2D_TEXT_RENDER_VALIGN_BOTTOM:
      ypos = render->height - render->image_height - render->ypad;
      break;
    case GST_IMX_G2D_TEXT_RENDER_VALIGN_BASELINE:
      ypos = render->height - (render->image_height + render->ypad);
      break;
    case GST_IMX_G2D_TEXT_RENDER_VALIGN_TOP:
      ypos = render->ypad;
      break;
    default:
      ypos = render->ypad;
  ...
  if (render->text_image) {
    if (render->use_ARGB) {
      gst_imx_g2d_text_renderer_image_to_argb (render, data, xpos, ypos,
          render->width * 4);
    } else {
      gst_imx_g2d_text_renderer_image_to_ayuv (render, data, xpos, ypos,
          render->width * 4);
    }
  }
...
static gboolean
gst_imx_g2d_text_render_event (GstPad * pad, GstObject * parent, GstEvent * event)
{
  GstImxG2DTextRender *render = GST_IMX_G2D_TEXT_RENDER (parent);
  gboolean ret = TRUE;
...
static void
gst_imx_g2d_text_render_finalize (GObject * object)
{
  GstImxG2DTextRender *render = GST_IMX_G2D_TEXT_RENDER (object);
...
static void
gst_imx_g2d_text_render_init (GstImxG2DTextRender * render)
{
  ...
  gst_pad_set_chain_function (render->sinkpad,
      GST_DEBUG_FUNCPTR (gst_imx_g2d_text_render_chain));
  gst_pad_set_event_function (render->sinkpad,
      GST_DEBUG_FUNCPTR (gst_imx_g2d_text_render_event));
  ...
  render->layout =
      pango_layout_new (GST_IMX_G2D_TEXT_RENDER_GET_CLASS (render)->pango_context);
...
static void
gst_imx_g2d_text_render_set_property (GObject * object, guint prop_id,
  ...
  switch (prop_id) {
    ...
    case PROP_FONT_DESC:
    {
      ...
      if (desc) {
        ...
        gst_imx_g2d_text_render_adjust_values_with_fontdesc (render, desc);
...
static void
gst_imx_g2d_text_render_get_property (GObject * object, guint prop_id,
