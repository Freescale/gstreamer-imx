...
static void gst_imx_audio_mp3_enc_class_init(GstImxAudioMp3EncClass *klass)
{
	...
	GST_DEBUG_CATEGORY_INIT(imx_audio_mp3_enc_debug, "imxmp3audioenc", 0, "Freescale i.MX MP3 encoder");
	...
	gst_element_class_set_static_metadata(
		element_class,
		"Freescale i.MX MP3 encoder",
		"Codec/Encoder/Audio",
		"encodes PCM data to MP3 using the Freescale i.MX MP3 encoder",
