...
static gboolean gst_fsl_vpu_enc_alloc_phys_mem(gsize size, gst_fsl_phys_mem_block *block)
{
	VpuEncRetCode ret;
	VpuMemDesc mem_desc;
...
static gboolean gst_fsl_vpu_enc_free_phys_mem(gst_fsl_phys_mem_block *block)
{
        VpuEncRetCode ret;
        VpuMemDesc mem_desc;
...
gst_fsl_phys_mem_allocator gst_fsl_vpu_enc_alloc =
{
	gst_fsl_vpu_enc_alloc_phys_mem,
	gst_fsl_vpu_enc_free_phys_mem
};
