...
static void* gst_imx_audio_uniaudio_dec_malloc(size_t size);
...
static void gst_imx_audio_uniaudio_dec_class_init(GstImxAudioUniaudioDecClass *klass)
{
	...
	GST_DEBUG_CATEGORY_INIT(imx_audio_uniaudio_dec_debug, "imxuniaudiodec", 0, "NXP i.MX uniaudio decoder");
